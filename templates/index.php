<?php
$_file = __FILE__;require_once(realpath(dirname($_file).'/../../../')."/include/initapi.php");

$authorityIds="";
if(isset($_SESSION["admin"]["authorityIds"])){
    $authorityIds = $_SESSION["admin"]["authorityIds"];
}
    ...
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    <a href="javascript:;">
                        <cite><?php if (isset($_SESSION["admin"]["nickName"])){echo($_SESSION["admin"]["nickName"]);}else{ echo "未登录";}?></cite>
                    </a>
                    <dl class="layui-nav-child">
                        <?php if(strpos($authorityIds,",17,")!=false) {?>
                        <dd><a lay-href="/admin/src/views/admin/user/info.html">基本资料</a></dd>
                        <dd><a lay-href="/admin/src/views/admin/user/password.html">修改密码</a></dd>
                        <hr>
                        <?php }?>
                        <dd style="text-align: center;"><a lay-href="/json/admin/login.php?t=loginout">退出</a></dd>
                    </dl>
                </li>
        ...
        <div class="layui-side layui-side-menu">
            <div class="layui-side-scroll">
                <div class="layui-logo" lay-href="{%url 'app01:main' %}">
                    <span>找直播后台管理</span>
                </div>
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
                   <!-- <li data-name="home" class="layui-nav-item layui-nav-itemed">
                    ...
                    <?php if(strpos($authorityIds,",1,")!=false||strpos($authorityIds,",2,")!=false) {?>
                    <li data-name="component" class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <?php if(strpos($authorityIds,",1,")!=false) {?>
                                <dd data-name="console" >
                                    <a lay-href="subscribe/default.html">51订阅列表</a>
                                </dd>
                                    <dd data-name="console" >
                                        <a lay-href="subscribe/default_zb.html">天猫订阅列表</a>
                                    </dd>
                                <?php }
                                if(strpos($authorityIds,",2,")!=false) {
                                ?>
                                <dd data-name="console">
                                    <a lay-href="recommend/default.html">51推荐列表</a>
                                </dd>
                                    <dd data-name="console">
                                        <a lay-href="recommend/default_zb.html">天猫推荐列表</a>
                                    </dd>
                                <?php }?>
                            </dl>
                        </li>
                    <?php }?>
                    <?php
                    if(strpos($authorityIds,",3,")!=false
                        ||strpos($authorityIds,",4,")!=false
                        ||strpos($authorityIds,",5,")!=false
                        ||strpos($authorityIds,",6,")!=false
                        ||strpos($authorityIds,",7,")!=false
                        ||strpos($authorityIds,",8,")!=false
                        ||strpos($authorityIds,",9,")!=false
                        ||strpos($authorityIds,",18,")!=false) {?>
					 <li data-name="component" class="layui-nav-item">
                        <a href="javascript:;" lay-tips="运营管理" lay-direction="2">
                            <i class="layui-icon layui-icon-component"></i>
                            <cite>数据管理</cite>
                        </a>
                         <?php if(strpos($authorityIds,",3,")!=false) {?>
                             <dl class="layui-nav-child">
                                 <dd data-name="console">
                                     <a lay-href="catchlog/default.html">频道统计</a>
                                 </dd>
                             </dl>
                             <dl class="layui-nav-child">
                                 <dd data-name="console">
                                     <a lay-href="catchlog/sportTypedefault.html">类型统计</a>
                                 </dd>
                             </dl>
                         <dl class="layui-nav-child">
                             <dd data-name="console" >
                                 <a lay-href="program/default.html">节目列表</a>
                             </dd>
                         </dl>
                         <?php }?>
                         <?php if(strpos($authorityIds,",4,")!=false) {?>
						<dl class="layui-nav-child">
                            <dd data-name="console" >
                                <a lay-href="country/default.html">国家列表</a>
                            </dd>

                        </dl>
                         <?php }?>
                         <?php if(strpos($authorityIds,",5,")!=false) {?>
                         <dl class="layui-nav-child">
                             <dd data-name="console" >
                                 <a lay-href="tv/default.html">电视台列表</a>

                             </dd>

                         </dl>
                         <?php }?>
                         <?php if(strpos($authorityIds,",6,")!=false) {?>
                         <dl class="layui-nav-child">
                             <dd data-name="console" >
                                 <a lay-href="tvchannel/default.html">频道列表</a>

                             </dd>

                         </dl>
                         <?php }?>
                         <?php if(strpos($authorityIds,",7,")!=false) {?>
                         <dl class="layui-nav-child">
                             <dd data-name="console" >
                                 <a lay-href="zhibohouse/default.html">直播间列表</a>
                         ...
                         <?php }?>
                         <?php if(strpos($authorityIds,",8,")!=false) {?>
                         <dl class="layui-nav-child">
                             <dd data-name="console" >
                                 <a lay-href="live_signal/default.html">信号源列表</a>
                         ...
                         <?php }?>
                         <?php if(strpos($authorityIds,",18,")!=false) {?>
                             <dl class="layui-nav-child">
                                 <dd data-name="console" >
                                     <a lay-href="index/index.html">幻灯列表</a>
                                 </dd>
                             </dl>
                             <dl class="layui-nav-child">
                                 <dd data-name="console" >
                                     <a lay-href="tvsouad/index.html">Tvsou幻灯</a>
                                 </dd>
                             </dl>
                         <?php }?>
                         <?php if(strpos($authorityIds,",19,")!=false) {?>
                             <dl class="layui-nav-child">
                                 <dd data-name="console" >
                                     <a lay-href="ask/indexask.html">问答列表</a>
                                 </dd>
                             </dl>
                             <dl class="layui-nav-child">
                                 <dd data-name="console" >
                                     <a lay-href="ask/indexreply.html">回复列表</a>
                                 </dd>
                             </dl>
                         <?php }?>
                         <?php if(strpos($authorityIds,",9,")!=false) {?>
                         <dl class="layui-nav-child">
                             <dd data-name="console" >
                                 <a lay-href="links/index.html">友链列表</a>
                    ...
                    if(strpos($authorityIds,",3,")!=false
                        ...
                        <li data-name="component" class="layui-nav-item">
                            ...
                            <?php if(strpos($authorityIds,",3,")!=false) {?>
                                <dl class="layui-nav-child">
                                    <dd data-name="console" >
                                        <a lay-href="program/default_user.html">节目列表</a>
                                    </dd>
                                </dl>
                            <?php }?>
                            <?php if(strpos($authorityIds,",7,")!=false) {?>
                                <dl class="layui-nav-child">
                                    <dd data-name="console" >
                                        <a lay-href="zhibohouse/default_user.html">直播间列表</a>
                                    </dd>
                                </dl>
                            <?php }?>
                            <?php if(strpos($authorityIds,",8,")!=false) {?>
                                <dl class="layui-nav-child">
                                    <dd data-name="console" >
                                        <a lay-href="live_signal/default_user.html">信号源列表</a>
                                    </dd>
                                </dl>
                            <?php }?>
                        </li>
                    ...
                    <?php }?>
                    <?php
                    if(strpos($authorityIds,",20,")!=false ) {?>
                        <li data-name="component" class="layui-nav-item">
                            <a href="javascript:;" lay-tips="新闻管理" lay-direction="2">
                                <i class="layui-icon layui-icon-component"></i>
                                <cite>新闻管理</cite>
                            </a>
                            <?php if(strpos($authorityIds,",20,")!=false) {?>
                                <dl class="layui-nav-child">
                                    <dd data-name="console" >
                                        <a lay-href="news/defaulttype.html">类型列表</a>
                                    </dd>
                                </dl>
                                <dl class="layui-nav-child">
                                    <dd data-name="console" >
                                        <a lay-href="news/defaultnews.html">新闻列表</a>
                                    </dd>
                                </dl>
                            <?php }?>
                        </li>
                    ...
                    <?php }?>
                    <?php
                    if(strpos($authorityIds,",10,")!=false
                        ||strpos($authorityIds,",11,")!=false
                        ||strpos($authorityIds,",12,")!=false) {?>
						 <li data-name="component" class="layui-nav-item">
                        <a href="javascript:;" lay-tips="用户管理" lay-direction="2">
                            ...
                            <cite>用户管理</cite>
                             ...
                             <dl class="layui-nav-child">
                                 <?php if(strpos($authorityIds,",10,")!=false) {?>
                                 <dd>
                                     <a lay-href="admin/web_user/default.html">51live用户</a>
                                 </dd>
                                 <dd>
                                     <a lay-href="admin/web_user/default_zb.html">天猫用户</a>
                                 </dd>
                                 <?php }?>
                                 <?php if(strpos($authorityIds,",11,")!=false) {?>
                                 <dd>
                                     <a lay-href="admin/admin.html">后台管理员</a>
                                 </dd>
                                 <?php }?>
                                 <?php if(strpos($authorityIds,",12,")!=false) {?>
                                 <dd>
                                     <a lay-href="admin/role.html">角色管理</a>
                                 </dd>
                                 <?php }?>
                             </dl>
						</li>
                    <?php }?>
                    <?php
                    if(strpos($authorityIds,",13,")!=false
                        ||strpos($authorityIds,",14,")!=false
                        ||strpos($authorityIds,",15,")!=false
                        ||strpos($authorityIds,",16,")!=false) {?>
						<li data-name="component" class="layui-nav-item">
                        <a href="javascript:;" lay-tips="体育管理" lay-direction="2">
                            <i class="layui-icon layui-icon-component"></i>
                            <cite>体育管理</cite>
                        </a>
                            <?php if(strpos($authorityIds,",13,")!=false) {?>
                            <dl class="layui-nav-child">
                                <dd data-name="console" >
                                    <a lay-href="sport/sporttype.html">类型列表</a>
                                </dd>

                            </dl>
                            <?php }?>
                            <?php if(strpos($authorityIds,",15,")!=false) {?>
                                <dl class="layui-nav-child">
                                    <dd data-name="console" >
                                        <a lay-href="sport/teamList.html">球队列表</a>
                            ...
                            <?php if(strpos($authorityIds,",14,")!=false) {?>
						<dl class="layui-nav-child">
                            <dd data-name="console" >
                                <a lay-href="sport/schedulelist.html">赛程列表</a>
                            </dd>

                        </dl>
                            <?php }?>

                            <?php if(strpos($authorityIds,",16,")!=false) {?>
                            <dl class="layui-nav-child">
                                <dd data-name="console" >
                                    <a lay-href="sport/playerlist.html">球员列表</a>
                    ...
                    <?php }?>
                    <?php
                    if(strpos($authorityIds,",21,")!=false
                        ||strpos($authorityIds,",22,")!=false ) {?>
                        <li data-name="component" class="layui-nav-item">
                            <a href="javascript:;" lay-tips="体育管理" lay-direction="2">
                                <i class="layui-icon layui-icon-component"></i>
                                <cite>其他管理</cite>
                            ...
                            <?php if(strpos($authorityIds,",21,")!=false) {?>
                                <dl class="layui-nav-child">
                                    <dd data-name="console" >
                                        <a lay-href="catchlog/default360.html">360统计</a>
                                    </dd>

                                </dl>
                                <dl class="layui-nav-child">
                                    <dd data-name="console" >
                                        <a lay-href="360/default.html">360数据</a>
                                    </dd>
                                </dl>
                            <?php }?>
                            <?php if(strpos($authorityIds,",22,")!=false) {?>
                                <dl class="layui-nav-child">
                                    <dd data-name="console" >
                                        <a lay-href="copyright/default.html">版权列表</a>
                                    </dd>
                                </dl>
                            <?php }?>
                            <?php if(strpos($authorityIds,",23,")!=false) {?>
                                <dl class="layui-nav-child">
                                    <dd data-name="console" >
                                        <a lay-href="correct/default.html">排除列表</a>
                                    </dd>
                                </dl>
                            <?php }?>
                        </li>
        ...
        <div class="layadmin-pagetabs" id="LAY_app_tabs">
            ...
            <div class="layui-tab" lay-unauto lay-allowClose="true" lay-filter="layadmin-layout-tabs">
                <ul class="layui-tab-title" id="LAY_app_tabsheader">
                    <li lay-id="{%url 'app01:main' %}" lay-attr="{%url 'app01:main' %}" class="layui-this"><i class="layui-icon layui-icon-home"></i></li>
                </ul>
            </div>
        </div>
        ...
        <div class="layui-body" id="LAY_app_body">
            <div class="layadmin-tabsbody-item layui-show">
                <iframe src="{%url 'app01:main' %}" frameborder="0" class="layadmin-iframe"></iframe>
            </div>
        </div>
