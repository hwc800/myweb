...
function OnYiwen(id) {
    //取消背诵
    document.getElementById("btnBeisong" + id).src = "https://song.gushiwen.cn/siteimg/bei-pic.png";
    ...
    if (document.getElementById("btnYiwen" + id).alt == "译文" && document.getElementById("btnZhushi" + id).alt == "注释" && document.getElementById("btnShangxi" + id).alt == "赏析") {
        document.getElementById("btnYiwen" + id).src = "https://song.gushiwen.cn/siteimg/yi-pic2.png";
        ...
        document.getElementById("btnYiwen" + id).src = "https://song.gushiwen.cn/siteimg/yi-pic.png";
    ...
    xmlhttp.onreadystatechange = function () {
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            if (xmlhttp.responseText == "未登录") {
                window.parent.window.location.href = "/user/login.aspx";
            }
            else {
    ...
    xmlhttp.open("GET", "/nocdn/ajaxshiwencont.aspx?id=" + id+"&value="+value, false);
    xmlhttp.send();
}
...
function OnZhushi(id) {
    ...
    var value = "cont";
    if (document.getElementById("btnYiwen" + id).alt == "译文" && document.getElementById("btnZhushi" + id).alt == "注释" && document.getElementById("btnShangxi" + id).alt == "赏析") {
        document.getElementById("btnZhushi" + id).src = "https://song.gushiwen.cn/siteimg/zhu-pic2.png";
        ...
        document.getElementById("btnZhushi" + id).src = "https://song.gushiwen.cn/siteimg/zhu-pic.png";
...
function OnShangxi(id) {
    ...
    var value = "cont";
    if (document.getElementById("btnYiwen" + id).alt == "译文" && document.getElementById("btnZhushi" + id).alt == "注释" && document.getElementById("btnShangxi" + id).alt == "赏析") {
        document.getElementById("btnShangxi" + id).src = "https://song.gushiwen.cn/siteimg/shang-pic2.png";
        ...
        document.getElementById("btnShangxi" + id).src = "https://song.gushiwen.cn/siteimg/shang-pic.png";
...
function OnBeisong(id, from) {
    if (getCookie('gsw2017user') == null) {
        window.parent.window.location.href = "https://so.gushiwen.cn/user/login.aspx?from=" + encodeURIComponent(window.location.href);
    }
    else {
        var value = "cont";
        if (document.getElementById("btnBeisong" + id).alt == "背诵") {
            ...
            document.getElementById("btnBeisong" + id).src = "https://song.gushiwen.cn/siteimg/bei-pic2.png";
...
function changeLike(id,idkey, from) {
    if (getCookie('gsw2017user') == null) {
        ...
        if (likeImg == -1) {
            ...
            xmlhttp.onreadystatechange = function () {
                if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                    document.getElementById('likeImg' + id).src = 'https://song.gushiwen.cn/siteimg/shou-cang.png';
...
function clickType() {
    if (document.getElementById("type1").style.height == "auto") {
        document.getElementById("imgType1").src = "https://song.gushiwen.cn/siteimg/jianTop.png";
        document.getElementById("type1").style.height = "26px";

    }
    else {
        document.getElementById("imgType1").src = "https://song.gushiwen.cn/siteimg/jianBtn.png";
...
function clickType2() {
    if (document.getElementById("type2").style.height == "auto") {
        document.getElementById("imgType2").src = "https://song.gushiwen.cn/siteimg/jianTop.png";
        document.getElementById("type2").style.height = "26px";
    }
    else {
        document.getElementById("imgType2").src = "https://song.gushiwen.cn/siteimg/jianBtn.png";
...
function clickType3() {
    if (document.getElementById("type3").style.height == "auto") {
        document.getElementById("imgType3").src = "https://song.gushiwen.cn/siteimg/jianTop.png";
        document.getElementById("type3").style.height = "26px";
    }
    else {
        document.getElementById("imgType3").src = "https://song.gushiwen.cn/siteimg/jianBtn.png";
    ...
    xmlhttp.onreadystatechange = function () {
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            if (document.getElementById('ziliaoPlay' + id).style.display == "block") {
                document.getElementById('speakerimgZiliaoquan' + id).src = "https://song.gushiwen.cn/siteimg/speak-erOk.png";
            }
        }
    }
        ...
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            if (xmlhttp.responseText == "未登录") {
                ...
                if (document.getElementById('fanyiPlay' + id).style.display == "block") {
                    document.getElementById('speakerimgFanyiquan' + id).src = "https://song.gushiwen.cn/siteimg/speak-erOk.png";
                }
            }
        }
    }
        ...
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            if (xmlhttp.responseText == "未登录") {
                ...
                if (document.getElementById('shangxiPlay' + id).style.display == "block") {
                    document.getElementById('speakerimgShangxiquan' + id).src = "https://song.gushiwen.cn/siteimg/speak-erOk.png";
                }
            }
        }
    }
    xmlhttp.open("GET", "static/nocdn/ajaxshangxi.aspx?id=" + idjm, false);
    xmlhttp.send();
}
    ...
    if (document.getElementById('shangxiPlay' + id).style.display == "none") {
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById('speakerimgShangxi' + id).src = "https://song.gushiwen.cn/siteimg/speak-erOk.png";
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById('speakerimgShangxi' + id).src = "https://song.gushiwen.cn/siteimg/speak-er.png";
                if (document.getElementById('speakerimgShangxiquan' + id)) {
                    document.getElementById('speakerimgShangxiquan' + id).src = "https://song.gushiwen.cn/siteimg/speak-er.png";
                }
                document.getElementById("shangxiPlay" + id).innerHTML = xmlhttp.responseText;
            }
        }
    ...
    if (document.getElementById('fanyiPlay' + id).style.display == "none") {
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById('speakerimgFanyi' + id).src = "https://song.gushiwen.cn/siteimg/speak-erOk.png";
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById('speakerimgFanyi' + id).src = "https://song.gushiwen.cn/siteimg/speak-er.png";
                if (document.getElementById('speakerimgFanyiquan' + id)) {
                    document.getElementById('speakerimgFanyiquan' + id).src = "https://song.gushiwen.cn/siteimg/speak-er.png";
                }
                document.getElementById("fanyiPlay" + id).innerHTML = xmlhttp.responseText;
            }
        }
    ...
    if (document.getElementById('ziliaoPlay' + id).style.display == "none") {
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById('speakerimgZiliao' + id).src = "https://song.gushiwen.cn/siteimg/speak-erOk.png";
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById('speakerimgZiliao' + id).src = "https://song.gushiwen.cn/siteimg/speak-er.png";
                if (document.getElementById('speakerimgZiliaoquan' + id)) {
                    document.getElementById('speakerimgZiliaoquan' + id).src = "https://song.gushiwen.cn/siteimg/speak-er.png";
                }
                document.getElementById("ziliaoPlay" + id).innerHTML = xmlhttp.responseText;
            }
        }
    ...
    if (document.getElementById('authorPlay' + id).style.display == "none") {
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById('speakerimgAuthor' + id).src = "https://song.gushiwen.cn/siteimg/speak-erOk.png";
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById('speakerimgAuthor' + id).src = "https://song.gushiwen.cn/siteimg/speak-er.png";
                document.getElementById("authorPlay" + id).innerHTML = xmlhttp.responseText;
            }
        }
    ...
    if (document.getElementById('bookPlay' + id).style.display == "none") {
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById('speakerimgBook' + id).src = "https://song.gushiwen.cn/siteimg/speak-erOk.png";
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById('speakerimgBook' + id).src = "https://song.gushiwen.cn/siteimg/speak-er.png";
                document.getElementById("bookPlay" + id).innerHTML = xmlhttp.responseText;
            }
        }
    ...
    if (document.getElementById('bookvPlay' + id).style.display == "none") {
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById('speakerimgBookv' + id).src = "https://song.gushiwen.cn/siteimg/speak-erOk.png";
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById('speakerimgBookv' + id).src = "https://song.gushiwen.cn/siteimg/speak-er.png";
                document.getElementById("bookvPlay" + id).innerHTML = xmlhttp.responseText;
            }
        }
    ...
    if (document.getElementById('bvfanyiPlay' + id).style.display == "none") {
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById('speakerimgBvfanyi' + id).src = "https://song.gushiwen.cn/siteimg/speak-erOk.png";
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById('speakerimgBvfanyi' + id).src = "https://song.gushiwen.cn/siteimg/speak-er.png";
                document.getElementById("bvfanyiPlay" + id).innerHTML = xmlhttp.responseText;
            }
        }
...
(function() {
    ...
    jb("https://song.gushiwen.cn/huaci/graybox.css");
    jb("https://song.gushiwen.cn/huaci/blackdownbar.css");
    function s(a) {
    ...
    E.appendChild(I);
    I.innerHTML = '<img src="https://song.gushiwen.cn/siteimg/loading.gif" width="32" height="32" />';
    var l = e("iframe");
